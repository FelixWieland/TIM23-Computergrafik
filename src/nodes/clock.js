...
export class Clock {
     ...
     */
    constructor(scene, position, rotationY = 180, scale = 1) {
     ...
     */
    setup([clockGltf, minutehandGltf, hourhandGltf]) {
     ...
     */
    animate() {
        if (this.clockGroup === null || this.minuteHandMesh === null || this.hourHandMesh === null)
            return;
